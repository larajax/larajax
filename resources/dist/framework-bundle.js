...
if (!window.jax.AjaxExtras) {
  // Namespace
  window.jax.AjaxExtras = _namespace__WEBPACK_IMPORTED_MODULE_0__["default"];

  // Flash messages
  window.jax.flashMsg = _namespace__WEBPACK_IMPORTED_MODULE_0__["default"].flashMsg;

  // Progress bar
  window.jax.progressBar = _namespace__WEBPACK_IMPORTED_MODULE_0__["default"].progressBar;

  // Attach loader
  window.jax.attachLoader = _namespace__WEBPACK_IMPORTED_MODULE_0__["default"].attachLoader;
...
if (!window.jax.AjaxObserve) {
  // Namespace
  window.jax.AjaxObserve = _namespace__WEBPACK_IMPORTED_MODULE_1__["default"];

  // Control API
  window.jax.registerControl = _namespace__WEBPACK_IMPORTED_MODULE_1__["default"].registerControl;
  window.jax.importControl = _namespace__WEBPACK_IMPORTED_MODULE_1__["default"].importControl;
  window.jax.observeControl = _namespace__WEBPACK_IMPORTED_MODULE_1__["default"].observeControl;
  window.jax.fetchControl = _namespace__WEBPACK_IMPORTED_MODULE_1__["default"].fetchControl;
  window.jax.fetchControls = _namespace__WEBPACK_IMPORTED_MODULE_1__["default"].fetchControls;

  // Control base class
  window.jax.ControlBase = _control_base__WEBPACK_IMPORTED_MODULE_0__.ControlBase;
...
if (!window.jax.AjaxTurbo) {
  // Namespace
  window.jax.AjaxTurbo = _namespace__WEBPACK_IMPORTED_MODULE_0__["default"];

  // Visit helper
  window.jax.visit = _namespace__WEBPACK_IMPORTED_MODULE_0__["default"].visit;

  // Enabled helper
  window.jax.useTurbo = _namespace__WEBPACK_IMPORTED_MODULE_0__["default"].isEnabled;

  // Page ready helper
  window.jax.pageReady = _namespace__WEBPACK_IMPORTED_MODULE_0__["default"].pageReady;
