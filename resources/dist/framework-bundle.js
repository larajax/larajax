...
window['${id}']();`;
  ...
  var ScopeObserver = class {
    constructor(element, delegate) {
      ...
      this.parkedScopesByElement = /* @__PURE__ */ new Map();
      this.parkedElementsByBoundary = /* @__PURE__ */ new Map();
      this.boundaryByElement = /* @__PURE__ */ new Map();
